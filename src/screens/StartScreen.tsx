...
export function StartScreen({ poolCount, onBegin, onCodex, onOnline }: Props) {
        ...
        >
          ...
          <span className="min-w-0 flex-1">
            <span className="flex items-center gap-2">
              <span className="font-display text-[17px] font-bold uppercase tracking-[1px] text-gold-bright">Duelo online</span>
            ...
            <span className="mt-0.5 block text-[12.5px] leading-snug text-[#D0D4CC]">
              Crie uma sala, mande o código pros amigos e disputem ao vivo, cada um com sua line.
            </span>
          </span>
