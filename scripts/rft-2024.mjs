...
merge("2024", {
  ...
  Gumayusi:{ base:86, geral:69.7, playoff:[62,67,82] },
  Keria:   { base:86, geral:71.0, playoff:[61,67,86] },
  // Bilibili Gaming vice (base 84). Bin/Elk/Knight monstruosos; final em 5 jogos.
  Bin:     { base:84, geral:68.0, playoff:[63,68,75], vice:true },
  Xun:     { base:84, geral:66.0, playoff:[59,69,74], vice:true },
  Knight:  { base:84, geral:72.0, playoff:[70,84,66], vice:true },
  Elk:     { base:84, geral:66.0, playoff:[57,75,66], vice:true },
  ON:      { base:84, geral:68.0, playoff:[64,70,66], vice:true },
